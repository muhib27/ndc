...
public class CMListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
...
//
    public CMListAdapter(Context context, PaginationAdapterCallback mCallback) {
    ...
    public CMListAdapter(Context context) {
        this.context = context;
        pigeonholeDataModelList = new ArrayList<>();
    }

    public CMListAdapter(Context context, ArrayList<String> strList) {
        this.context = context;
        this.mCallback = mCallback;
...
//    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case ITEM:
                View viewItem = inflater.inflate(R.layout.cm_single_row, parent, false);
