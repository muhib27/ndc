...
public class DashboardPigeonholeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
...
//
    public DashboardPigeonholeAdapter(Context context, PaginationAdapterCallback mCallback) {
    ...
    public DashboardPigeonholeAdapter(Context context) {
        this.context = context;
        pigeonholeDataModelList = new ArrayList<>();
    }

    public DashboardPigeonholeAdapter(Context context, ArrayList<String> strList) {
        this.context = context;
        this.mCallback = mCallback;
