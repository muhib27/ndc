 ...
 */
public class RoutineBlueFragment extends Fragment {


    public RoutineBlueFragment() {
    ...
    BlueRoutineAdapter blueRoutineAdapter;
    UIHelper uiHelper;
...
//        routineAdapter.setData(getStrList());
    ...
    private void callRoutineApi() {
        ...
        RetrofitApiClient.getApiInterface().getBlueRoutine(AppSharedPreference.getApiKey())
