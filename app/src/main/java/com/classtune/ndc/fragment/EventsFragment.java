...
import com.classtune.ndc.adapter.EventsAdapter;
...
//        routineAdapter.setData(getStrList());
    ...
    private void callRoutineApi() {
        ...
        RetrofitApiClient.getApiInterface().getEvents(AppSharedPreference.getApiKey())
                ...
                .subscribe(new Observer<Response<EventsResponseModel>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(Response<EventsResponseModel> value) {
